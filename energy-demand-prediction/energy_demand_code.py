...
TRAIN_PATH = PROJECT_DIR / "energy_demand_train.csv"
TEST_PATH = PROJECT_DIR / "energy_demand_test.csv"
RESULTS_PATH = PROJECT_DIR / "energy_demand_results.json"
CV_SUMMARY_PATH = PROJECT_DIR / "experiments" / "energy_demand_cv_summary.csv"
...
def solve_project(save_outputs: bool = True) -> tuple[dict, dict]:
...
if __name__ == "__main__":
    solve_project(save_outputs=True)
