...
TRAIN, TEST = ROOT / "trees_train.csv", ROOT / "trees_test.csv"
OUT = ROOT / "trees_results.json"
...
def build_result(verbose=False):
    ...
    return {
        "_description": "trees results for student 9618; shape follows trees_results_example.json.",
...
def validate(result):
    example = json.loads((ROOT / "trees_results_example.json").read_text())
