...
def main() -> None:
    ...
    pd.DataFrame(splitter_records).to_csv(
        EXPERIMENT_DIR / "rf_clf_selected_fold_assignments.csv", index=False
    )
...
- Threshold accuracy was not used for selection because the assignment grades
...
Calibration is evaluated because the grading target is cross-entropy rather
