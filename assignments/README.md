...
| --- | --- | --- |
| `01-regression` | Linear regression | `regression_slides.pdf`, `regression_results.csv`, `regression_summary.txt` |
| `02-classification` | Classification and logistic-model selection | `classification_slides.pdf`, `classification_results.csv`, `classification_summary.txt` |
