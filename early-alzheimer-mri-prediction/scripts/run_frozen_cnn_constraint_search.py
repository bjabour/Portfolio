...
OUTPUT_DIR = Path("results") / "experiments" / "frozen_cnn_constraint_search"
...
def main() -> None:
    ...
    previous_path = project_root / "results" / "experiments" / "type2_constraints" / "constraint_comparison.csv"
    current = selected[
        [
            "model",
            "constraint",
