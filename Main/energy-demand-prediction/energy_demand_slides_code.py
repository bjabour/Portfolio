...
from energy_demand_code import (
    PROJECT_DIR,
    BOUNDARY_LEFT,
    BOUNDARY_RIGHT,
    CV_SUMMARY_PATH,
...
PDF_PATH = Path(os.environ.get("ENERGY_DEMAND_SLIDES_PDF_PATH", PROJECT_DIR / "energy_demand_slides.pdf"))
...
BOOTSTRAP_SUMMARY_PATH = EXPERIMENTS_DIR / "energy_demand_bootstrap_curve_summary.csv"
B_BOOTSTRAP = 200
...
def main():
    ...
    results, _ = solve_project(save_outputs=True)
    ...
    with PdfPages(PDF_PATH) as pdf:
        ...
        overview = (
            "Data files:\n"
            "  energy_demand_train.csv\n"
            "  energy_demand_test.csv\n\n"
