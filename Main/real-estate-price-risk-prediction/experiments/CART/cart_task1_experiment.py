...
def cross_validate_depths(
    ...
    return (
        ...
        requested_oof,
        pd.DataFrame(project_rows).sort_values("source_row_index"),
    )
...
def main() -> None:
    ...
    initial_cv, _, fold_projects = cross_validate_depths(
        x_train,
        y_train,
        OFFICIAL_DEPTHS,
        OFFICIAL_CV_SEED,
    ...
    official_cv, selected_oof, fold_projects = cross_validate_depths(
        x_train,
        y_train,
        OFFICIAL_DEPTHS,
        OFFICIAL_CV_SEED,
    ...
    fold_projects.to_csv(
        EXPERIMENT_DIR / "official_cv_fold_projects.csv",
        index=False,
    )
    pd.DataFrame(
        {
